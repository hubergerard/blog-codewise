(function($) {
  "use strict";
  const PLACEHOLDER_DIV = 'placeholder-div';
  ...
  wind.on('scroll', function () {
    ...
    if (scroll < 180) {
      ...
      if(!placeholderDiv){
        ...
        const navbar = document.getElementById(STICKY_HEADER_ID);
        div.style.minHeight = getComputedStyle(navbar).height;
      }
